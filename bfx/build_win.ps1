...
$VCVARS_X86_64 = $env:VCVARS_X86_64 ?? 'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars64.bat'
$VCVARS_ARM64  = $env:VCVARS_ARM64 ??  'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvarsamd64_arm64.bat'
...
$X86_64_NAME = "x86_64"
$X86_64_BUILD_DIR = "$(Get-Location)\build\${X86_64_NAME}"
...
$ARM64_NAME = "arm64"
$ARM64_BUILD_DIR = "$(Get-Location)\build\${ARM64_NAME}"
