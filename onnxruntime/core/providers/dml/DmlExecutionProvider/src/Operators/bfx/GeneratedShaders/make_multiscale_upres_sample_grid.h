...
; -------------------- ----- ------ -------- -------- ------- ------
; no parameters
; shader hash: 6b153c0b3f6a9da4740c1a4d303259bd
;
...
; <label>:12                                      ; preds = %0
  ...
  %23 = call %dx.types.ResRet.f32 @dx.op.rawBufferLoad.f32(i32 139, %dx.types.Handle %2, i32 5, i32 0, i8 1, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
  %24 = extractvalue %dx.types.ResRet.f32 %23, 0
  %25 = call %dx.types.ResRet.f32 @dx.op.rawBufferLoad.f32(i32 139, %dx.types.Handle %2, i32 6, i32 0, i8 1, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
  %26 = extractvalue %dx.types.ResRet.f32 %25, 0
  %27 = sitofp i32 %4 to float
  %28 = fadd fast float %27, 5.000000e-01
  %29 = fadd fast float %28, %14
  %30 = fsub fast float %29, %22
  %31 = fdiv fast float %30, %26
  %32 = fsub fast float %22, %18
  ...
  %39 = fsub fast float %38, %24
  %40 = fdiv fast float %39, %26
  %41 = fsub fast float %24, %20
  ...
  %49 = extractvalue %dx.types.CBufRet.i32 %6, 0
...
; <label>:52                                      ; preds = %52, %51
  ...
  %61 = add i32 %59, %4
  %62 = add i32 %61, %60
  call void @dx.op.rawBufferStore.f32(i32 140, %dx.types.Handle %1, i32 %62, i32 0, float %46, float undef, float undef, float undef, i8 1, i32 4)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  ...
  %71 = add i32 %70, %68
  %72 = add i32 %71, %69
  call void @dx.op.rawBufferStore.f32(i32 140, %dx.types.Handle %1, i32 %72, i32 0, float %48, float undef, float undef, float undef, i8 1, i32 4)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  %73 = add nuw nsw i32 %53, 1
  %74 = call %dx.types.CBufRet.i32 @dx.op.cbufferLoadLegacy.i32(i32 59, %dx.types.Handle %3, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
...
const unsigned char g_make_multiscale_upres_sample_grid[] = {
  0x44, 0x58, 0x42, 0x43, 0x6a, 0xdd, 0xf0, 0xf6, 0x8c, 0xfb, 0xc1, 0x75,
  0xbd, 0xe5, 0x85, 0xf1, 0xf2, 0xfb, 0xed, 0x7a, 0x01, 0x00, 0x00, 0x00,
  0xe4, 0x08, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x6b, 0x15, 0x3c, 0x0b, 0x3f, 0x6a, 0x9d, 0xa4,
  0x74, 0x0c, 0x1a, 0x4d, 0x30, 0x32, 0x59, 0xbd, 0x44, 0x58, 0x49, 0x4c,
  ...
  ,
